        ...
        <div className="space-y-4 md:space-y-6 lg:text-left">
          ...
          <div className="text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
            <p className="indent-8">
              3min°是我独立设计并搭建的个人网站，创建网站的目的是为了记录我在生活和职业道路上的成长，我也希望你能通过我的网站内容了解我。
            </p>
            <p className="indent-8">
              我喜欢勇敢主动的结识一些不同年龄层的朋友，他们的人生阅历让我受益良多。我尽量保持每天运动和阅读的习惯，因为热爱，会经常参与一些户外活动。我对于新鲜和有挑战性的事物总是充满激情。我很感激朋友们能够接纳和包容我一起成长。目前有
              {calculateYearDifference(2020)}年web前端开发经验和
              {calculateYearDifference(2023)}
              年产品经验，现在正积极思考和探索更适合自己的职业发展方向。
            </p>
          </div>
        </div>
      </motion.div>
