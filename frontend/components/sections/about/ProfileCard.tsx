      ...
      >
        ...
        <div className="space-y-4 md:space-y-6 lg:text-left">
          ...
          <div className="text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <p className="indent-8">
              你好，我是曹潇，1997年出生，2020年大学毕业。性格在ENTJ和INTJ之间不断切换。我喜欢勇敢主动的结识一些不同年龄层的朋友，他们的人生阅历让我受益良多。我尽量保持每天运动和阅读的习惯，因为热爱，会经常参与一些户外活动。对于新鲜和有挑战性的事物总是充满好奇，不过有时候做人做事会显得不够成熟。我很感激周围的朋友能够包容我，陪着我成长。目前从事前端开发工作
