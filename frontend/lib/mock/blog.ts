...
// 博客配置常量（控制分页、精选、相关文章和摘要/预览长度等展示行为）
export const BLOG_CONFIG = {
  POSTS_PER_PAGE: 6, // 每页显示的文章数量（用于分页）
  FEATURED_POSTS_COUNT: 3, // 精选文章展示数量（如首页或推荐区）
  RELATED_POSTS_COUNT: 3, // 详情页底部“相关文章”展示数量
  EXCERPT_LENGTH: 120, // 列表页摘要的最大字符数（超出时截断）
  CONTENT_PREVIEW_LENGTH: 50, // 搜索/预览模式的内容截断长度（字符数）
};
...
export const mockPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "深入了解 Next.js 15 带来的新功能和改进，包括性能优化、开发体验提升等重要更新",
    content: [
      "# Next.js 15 新特性解析",
      "",
      "Next.js 15 带来了许多激动人心的新特性，包括改进的性能、更好的开发体验和新的 API 设计。本文将详细介绍这些新功能如何提升我们的开发效率。",
      "",
      "![Next.js 15 特性示意图](/images/fsr.png)",
      "",
      "## 核心更新",
      "",
      "- 更快的构建与热更新体验",
      "- Turbopack 的稳定性进一步提升",
      "- App Router 能力增强与数据获取优化",
      "",
      "```ts",
      "// 示例：在 Server Components 中进行数据获取",
  ...
  },
  {
    ...
    excerpt:
      "探讨在现代 React 应用中如何选择和使用合适的状态管理方案，提升应用性能",
    content:
      "React 状态管理是构建复杂应用的关键。本文分析了 useState、useReducer、Context API 和第三方库的使用场景，帮助开发者做出最佳选择。",
    date: "2024-01-10",
    readTime: "8 分钟",
    category: "技术",
  ...
  },
  {
    ...
    content:
      "开发个人网站是一个很好的学习机会。从技术选型到UI设计，再到部署上线，每个环节都有很多值得分享的经验和踩过的坑。",
    date: "2024-01-05",
    readTime: "6 分钟",
    category: "分享",
    tags: ["开发", "经验", "分享", "网站"],
  ...
  },
  {
    ...
    content:
      "TypeScript 的类型系统非常强大，掌握泛型、条件类型、映射类型等高级特性，可以让我们写出更安全、更优雅的代码。",
    date: "2024-01-01",
    readTime: "7 分钟",
    category: "技术",
  ...
  },
  {
    ...
    content:
      "CSS Grid 是现代网页布局的强大工具。通过网格容器和网格项目的概念，我们可以轻松创建复杂的二维布局，告别传统的浮动和定位。",
    date: "2023-12-28",
    readTime: "10 分钟",
    category: "技术",
    tags: ["CSS", "Grid", "布局", "前端"],
  ...
  },
  {
    ...
    content:
      "作为程序员，很容易陷入加班和技术学习的循环中。如何在职业发展和个人生活之间找到平衡，是每个人都需要思考的问题。",
    date: "2023-12-25",
    readTime: "4 分钟",
    category: "生活",
    tags: ["生活", "思考", "平衡", "成长"],
  ...
  },
  {
    ...
    content:
      "Vue 3 的 Composition API 为组件逻辑复用提供了新的思路。通过组合式函数，我们可以更好地组织和复用代码逻辑。",
    date: "2023-12-20",
    readTime: "6 分钟",
    category: "技术",
  ...
  },
  {
    ...
    content:
      "前端性能优化是提升用户体验的关键。从资源加载、代码分割到缓存策略，每个细节都可能影响应用的性能表现。",
    date: "2023-12-15",
    readTime: "9 分钟",
    category: "技术",
    tags: ["性能优化", "前端", "用户体验"],
